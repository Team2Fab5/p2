$(document).ready(function() {
    ...
    function createUserRow(userData) {
      ...
      newTr.append("<td><a href='/task?user_id=" + userData.id + "'>Go to Tasks</a></td>");
      newTr.append("<td><a href='/dis?user_id=" + userData.id + "'>Create a Task</a></td>");
    ...
    function renderEmpty() {
      ...
      alertDiv.text("You must create a User before you can create a Task.");
